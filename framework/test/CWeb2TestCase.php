<?php
/**
 * This file contains the CWeb2TestCase class.
 *
...
/**
 * CWeb2TestCase is the base class for Web-based functional test case classes.
 *
 ...
 * @since 1.1
 */
abstract class CWeb2TestCase extends PHPUnit_Extensions_Selenium2TestCase
{
	/**
